...
# Author: Diego Souza
# 
# Description: This script will register the locally generated certificate in 
# every CSD installed in this machine. Buildx must be already configured in the 
# local machine and the certificate must be at ~/.certs.
###############################################################################
...
echo "Starting certificate deploy ..."
